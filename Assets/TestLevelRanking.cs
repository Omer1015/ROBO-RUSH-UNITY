...
public class TestLevelRanking : MonoBehaviour
{
    ...
    void Start()
    {
        if (timer != null)
        {
            ...
            if (finalTime <= 60) // 3 minutes or faster
            {
                ShowRankPanel(sRankPanel);
            }
            else if (finalTime <= 120) // 4 minutes or faster
            {
                ShowRankPanel(aRankPanel);
            }
            else if (finalTime <= 180) // 5 minutes or faster
            {
                ShowRankPanel(bRankPanel);
            }
            else if (finalTime <= 240) // 6 minutes or faster
            {
